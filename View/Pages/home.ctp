...
?>
<div class="hero-unit">
<h1>Hello, CakePHP world!</h1>
<h2><?php echo __d('cake_dev', 'Release Notes for CakePHP %s.', Configure::version()); ?></h2>
<h3><a href="http://cakephp.org/changelogs/1.3.6"><?php echo __d('cake_dev', 'Read the changelog'); ?> </a>
</h3>
<p>
	<?php
		if (is_writable(TMP)):
			echo '<span class="alert-message success">';
				echo __d('cake_dev', 'Your tmp directory is writable.');
			echo '</span>';
		else:
			echo '<span class="alert-message error">';
...
<div class="row">
	<div class="span5">
	<h2><?php echo __d('cake_dev', 'Getting Started'); ?></h2>
	<p>
		<?php
			echo $this->Html->link(
	...
	<div class="span5">
		<h2><?php echo __d('cake_dev', 'More about Cake'); ?></h2>
		<p>
	...
	<div class="span5">
		<h2><?php echo __d('cake_dev', 'Other Link'); ?></h2>
		<ul>
